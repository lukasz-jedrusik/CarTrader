...
using CarTrader.Services.Notifications.Domain.Exceptions;
using Microsoft.AspNetCore.Mvc;

namespace CarTrader.Services.Notifications.Api.Middleware
{
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            catch (Exception error)
            {
                ...
                switch(error)
                {
                    ...
                    {
                        // Other CarTrader.Services.Notifications errors and argument null
